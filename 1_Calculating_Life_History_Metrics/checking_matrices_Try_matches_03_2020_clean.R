...
sp_to_check_in_try$checknote[sp_to_check_in_try$SpeciesAuthor == study_list[44]] <-  
  "Survival issue in last stage, also model has density dependent seedling survival, I don't know how this was incorporated into cell [1,2]. Compadre team must have had extra information from somewhere"
sp_to_check_in_try$habitatAuthor[sp_to_check_in_try$SpeciesAuthor 
...
sp_to_check_in_try$checknote[sp_to_check_in_try$SpeciesAuthor 
                             == study_list[118]] <- "This transition matrix relates to transitions between vegetative and sexual states and not fecundity per se. Not appropriate to include"
sp_to_check_in_try$habitatAuthor[sp_to_check_in_try$SpeciesAuthor 
                                 == study_list[118]] <- NA
...
saveRDS(obs1,
        file =  "ammended_annual_compadre_data_13_03_2020.RData")
