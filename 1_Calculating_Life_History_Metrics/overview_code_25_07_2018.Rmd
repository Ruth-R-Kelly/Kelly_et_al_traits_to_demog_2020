...
This document is an overarching file which works with the r scripts in the same folder to calculate the demographic metrics used in Kelly et al. 2020.

Required code and datafiles for this code are as follows:

* COMPADRE_v.4.0.1.RData
* checking_matrices_Try_matches_08_06_2018_clean.r
* merging_matrices_08_06_2018.r
* seasonal_matrices_08_06_2018.R
* long_periods_analysis_16_04_2018.R
* splitting_seed_stage_number_08_06_2018.r
* metrics_annual_no_seeds_08_06_2018.R
* metrics_annual_1_seedstage_08_06_2018.R
* metrics_annual_2_seedstage_08_06_2018.R
* metrics_annual_3_seedstage_08_06_2018.R
...
Output of this code is a new RData file in the same format as compadre containing only these selected matrices and entitled : "ammended_annual_compadre_data_16_04_2018.RData" 

####

```{r Step 1 Select suitable matrices, include = FALSE}

source("checking_matrices_Try_matches_08_06_2018_clean.R")
```
...
This code requires the dataset "ammended_annual_compadre_data_08_06_2018.RData" created in the previous step.

This code outputs the dataset "selected_annual_matrices_merged_per_population_16_04_2018.RData" required in the next step.


```{r Temporal averaging of individual matrices}

source("merging_matrices_08_06_2018.r")
...
These matrices are then appended to the merged matrices from step 2 ("selected_annual_matrices_merged_per_population_08_06_2018.RData") and are outputted first as "selected_matrices_with_seasonal_merged_per_population_08_06_2018.RData" after seasonal matrices are added and then as "all_selected_matrices_merged_per_population_08_06_2018.RData" after long period matrices are added. 

```{r Step 3 Checking matrix adjustments and metric calculation for seasonal matrices}
source("seasonal_matrices_08_06_2018.R")
source("long_periods_analysis_08_06_2018.R")
...
This code requires the dataset "all_selected_matrices_merged_per_population_16_04_2018.RData" created in step 2. 

And outputs datasets separated by the number of seed stages in the matrices as : 
 
               No seedbank recorded = "annual_no_Seedbank_16_04_2017.RData"
               1 seedbank stage recorded = "annual_1yr_Seedbank_16_04_2018.RData"
               2 seedbank stage recorded = "annual_2yr_Seedbank_16_04_2018.RData"
               3 seedbank stage recorded = "annual_3yr_Seedbank_16_04_2018.RData"


```{r Step 3 Split matrices by number of seed stages}

source("splitting_seed_stage_number_08_06_2018.r")
...
File outputs = 
* "demography_non_seedbank_08_06_2018.csv"
* "demography_1yr_seedbank_08_06_2018.csv"
* "demography_2yr_seedbank_08_06_2018.csv"
* "demography_3yr_seedbank_08_06_2018.csv"
 

```{r Step 3 calculate life-history metrics for annual datasets}

source("metrics_annual_no_seeds_08_06_2018.R")
source("metrics_annual_1_seedstage_08_06_2018.R")
source("metrics_annual_2_seedstage_08_06_2018.R")
source("metrics_annual_3_seedstage_08_06_2018.R")
...
Then select a random representative population per species from these location
means.

Editted on 29/05/2018 to also export all of the demography locations to 

Output file: "metric_means_for_all_species_locations_by_habitats_08_06_2018.csv"

Output file used in step 6: "demo_means_selected_08_06_2018.csv"

```{r Step 5 combining metrics}
source("refining_metrics_dataset_06_06_2018.R")
...
#### Note this is where I stopped working on 06/03/2020

Selected species with 4 matching traits, LMA, LA, Height and seed mass. 

Required files: 
"all_trait_means20_04_2018_added_datasets.csv"
"demo_means_selected_08_06_2018.csv"

Output file: 
 - All demography and traits - "matching_trait_demo_data_08_06_2018.csv"
 - Four most frequently measured traits - "matching_4traits_demo_data_08_06_2018.csv" Height, LMA, LA and Seed mass
 - Three most frequently measured traits
 
 - "matching_4_H_LN_LMA_SM_traits_demo_data_25_07_2019.csv" Height, LMA, LN and Seed       mass
 - Three most frequently measured traits
 
 -"matching_3traits_demo_data_08_06_2018.csv" Height, LMA, and Seed mass
 
 
 
```{r Step 6 Merging demographic metrics and trait data}
source("match_demography_and_traits_08_06_2018.R")
